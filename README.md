...
Hopefully I wrote enough comments for it not to be a nightmare to dissect later.

All the server.js stuff is written by Claude, so good luck with that if you ever decide to change anything.
